...
Job.create(title: 'Dream Maker', description: 'We need a Ptolemy! ', start_date: '14/09/2015', duration: '30 weeks', hours: '45', location: 'NW51PE', wage: 10.50, requiredSkills: "Writing", employer_id: 1, contactName: "Sam", locationmap: 'https://maps.googleapis.com/maps/api/staticmap?center=NW51PE&zoom=15&size=600x600&markers=NW51PE', contactEmail: "sam@makers.com" )
Job.create(title: 'Dream Breaker', description: 'Someone to show Makers the harsh reality of life', start_date: '14/09/2015', duration: '30 weeks', hours: '45', location: 'SW152JQ', wage: 7.80, requiredSkills: "Security", employer_id: 1, contactName: "Dave", locationmap: 'https://maps.googleapis.com/maps/api/staticmap?center=SW152JQ&zoom=15&size=600x600&markers=SW152JQ', contactEmail: "dave@makers.com")
Job.create(title: 'Zoo Keeper', description: 'Someone to feed the seals', start_date: '14/09/2015', duration: '30 weeks', hours: '45', location: 'E152JS', wage: 9.60, requiredSkills: "Dog walking", locationmap: 'https://maps.googleapis.com/maps/api/staticmap?center=E152JS&zoom=15&size=600x600&markers=E152JS', employer_id: 2, contactName: "Steve", contactEmail: "Steve@ga.com")
