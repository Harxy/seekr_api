...
Jobseeker.create(name:"Rob", email:"rob@seekr.com", location:"lovelyville", imageURL:'https://s3-eu-west-1.amazonaws.com/makers-seekr/robimg.jpeg', PrimarySkill: 'Customer Service', SecondarySkill: 'Writing')
Jobseeker.create(name:"Jack", email:"jack@seekr.com", location:"lovelyville", imageURL:'https://s3-eu-west-1.amazonaws.com/makers-seekr/jackimg.png', PrimarySkill: 'Babysitting', SecondarySkill: 'Security')
